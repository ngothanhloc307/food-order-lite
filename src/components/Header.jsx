        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "ngothanhloc90@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col">
                <li
                  className="text-lg text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-200 px-4 py-2"
                  onClick={() => setIsMenu(false)}
                >
                  Home
                </li>
                <Link to={"/menu"}></Link>
                <li
                  className="text-lg text-x onClick={()=> setIsMenu(false)}tColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-200 px-4 py-2"
                  onClick={() => setIsMenu(false)}
                >
                  Menu
                </li>
