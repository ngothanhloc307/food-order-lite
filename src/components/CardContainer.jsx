...
const CardContainer = () => {
  ...
  return (
    <motion.div
      ...
      className=" fixed top-0 right-0 w-full md:w-375 h-[100vh] bg-white drop-shadow-sm flex flex-col z-[101]"
    >
      ...
      {cartItems && cartItems.length > 0 ? (
        <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
          ...
          {/* cart total section */}
          <div className="w-full h-full bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2">
